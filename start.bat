start "A" cmd /k java -classpath out\production\Project3.2 TCPSimulation.Main.RouterMain A
start "B" cmd /k java -classpath out\production\Project3.2 TCPSimulation.Main.RouterMain B
start "C" cmd /k java -classpath out\production\Project3.2 TCPSimulation.Main.RouterMain C
start "D" cmd /k java -classpath out\production\Project3.2 TCPSimulation.Main.RouterMain D
start "E" cmd /k java -classpath out\production\Project3.2 TCPSimulation.Main.RouterMain E
